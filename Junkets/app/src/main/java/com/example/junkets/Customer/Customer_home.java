...
//            super.onBackPressed();
            Toast.makeText(Customer_home.this, "Please LogOut To Exit", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.customer_view_center) {
          startActivity(new Intent(getApplicationContext(),Customer_view_Center.class));
